    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-2xl font-heading font-bold text-gray-900 dark:text-white">Media Library</h2>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-4">
                {uploadedFiles.length === 0 ? (
                    <div className="col-span-full py-12 text-center bg-white dark:bg-gray-800 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl">
                    ...
                    uploadedFiles.map((file, index) => (
                        <div key={file.public_id || index} className="group relative bg-white dark:bg-gray-800 rounded-lg border overflow-hidden aspect-square shadow-sm hover:shadow-md transition-shadow">
                            <img
                                src={file.url}
                                alt="Uploaded"
                            ...
                            <div className="absolute inset-0 bg-black/50 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                                ...
                                <button
                                    className="p-2 bg-white dark:bg-gray-800 text-red-600 rounded-full hover:bg-red-50 transition-colors"
                                    title="Delete"
