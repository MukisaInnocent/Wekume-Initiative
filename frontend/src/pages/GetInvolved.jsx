    ...
    return (
        <>
            ...
            <div className="relative bg-primary-900 text-white overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 md:py-32 relative z-10">
                    <div className="max-w-3xl">
                        ...
                        <div className="flex flex-wrap gap-4">
                            <Link to="/wekume-app" className="bg-white text-primary-900 px-8 py-4 rounded-full font-bold hover:bg-orange-400 hover:text-white transition-all shadow-lg flex items-center gap-2">
                                <Smartphone size={20} /> Download App
                            </Link>
                            <Link to="/contact" className="bg-white/10 backdrop-blur-md border border-white/30 text-white px-8 py-4 rounded-full font-bold hover:bg-white/20 transition-all flex items-center gap-2">
                ...
                {/* Decorative Blobs */}
                <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[800px] h-[800px] bg-purple-600 rounded-full blur-3xl opacity-20 pointer-events-none"></div>
                <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-96 h-96 bg-orange-600 rounded-full blur-3xl opacity-20 pointer-events-none"></div>
            </div>
                ...
                <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="bg-gradient-to-r from-purple-600 to-indigo-700 rounded-3xl p-10 md:p-16 text-center text-white shadow-2xl relative overflow-hidden">
                        ...
                        <div className="relative z-10">
                            ...
                            <Link to="/contact" className="bg-white text-purple-600 px-10 py-4 rounded-full font-bold hover:bg-orange-400 hover:text-white transition-all shadow-lg inline-flex items-center gap-2 transform hover:scale-105">
                                <Heart size={20} className="fill-current" /> Get in Touch
                            </Link>
                        </div>
                    </div>
                </div>
