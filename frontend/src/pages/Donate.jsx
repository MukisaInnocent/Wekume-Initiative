...
function Donate() {
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <div className="gradient-purple-orange text-white py-20 relative overflow-hidden">
                ...
                <div className="grid lg:grid-cols-5 gap-12">
                    ...
                    <div className="lg:col-span-3">
                        <div className="bg-white rounded-2xl shadow-2xl border border-primary-100 overflow-hidden">
                            <div className="bg-gradient-to-r from-primary-50 to-pink-50 p-6 border-b border-primary-100">
                                ...
                                <p className="text-sm text-gray-600 mt-1">All fields are required for transaction processing</p>
                            </div>
                            ...
                            {status === 'success' ? (
                                <div className="p-10 text-center animate-fade-in">
                                    ...
                                    <h3 className="text-3xl font-heading font-bold text-primary-900 mb-2">Thank You, {details.donor_name.split(' ')[0]}!</h3>
                                    <p className="text-gray-600 mb-8 text-lg">Your generosity makes a real difference in young lives.</p>

                                    {/* Confirmation Details */}
                                    <div className="bg-gradient-to-r from-primary-50 to-purple-50 border-2 border-primary-200 rounded-2xl p-6 mb-6 text-left">
                                        <div className="flex items-center gap-2 mb-4">
                                            <CheckCircle className="text-green-600" size={24} />
                                            <h4 className="font-bold text-primary-900 text-lg">Donation Confirmed</h4>
                                        </div>
                                        ...
                                        <div className="space-y-3 text-sm">
                                            <div className="flex justify-between items-center py-2 border-b border-primary-100">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className="font-bold text-primary-900">{transactionRef}</span>
                                                    <button
                                            ...
                                            <div className="flex justify-between py-2 border-b border-primary-100">
                                                ...
                                                <span className="font-bold text-gray-900">UGX {parseInt(amount).toLocaleString()}</span>
                                            </div>
                                            <div className="flex justify-between py-2 border-b border-primary-100">
                                                <span className="text-gray-600">Payment Method:</span>
                                                <span className="font-medium text-gray-900">{paymentMethod === 'mobile_money' ? 'Mobile Money' : 'Bank Transfer'}</span>
                                            </div>
                                    ...
                                    <div className="bg-gradient-to-r from-secondary-50 to-orange-50 border-2 border-secondary-200 rounded-2xl p-6 mb-8 text-left">
                                        ...
                                        <div className="bg-white rounded-lg p-4 mb-4">
                                            <p className="text-base font-medium text-gray-900 leading-relaxed">{instructions}</p>
                                        </div>
                                ...
                                <form onSubmit={handleDonate} className="p-6 md:p-8 space-y-6">
                                    ...
                                    {/* Donation Type */}
                                    <div>
                                        <label className="block text-sm font-bold text-primary-700 mb-3 uppercase tracking-wide">Donation Type</label>
                                        <div className="grid grid-cols-2 gap-3">
                                            <button
                                                type="button"
                                                onClick={() => setDonationType('one-time')}
                                                className={`py-3 px-4 rounded-xl font-semibold border-2 transition-all ${donationType === 'one-time' ? 'bg-primary-600 text-white border-primary-600 shadow-md' : 'bg-white text-primary-600 border-primary-200 hover:border-primary-400'}`}
                                            >
                                                One-Time
                                            </button>
                                            <button
                                                ...
                                                className={`py-3 px-4 rounded-xl font-semibold border-2 transition-all ${donationType === 'monthly' ? 'bg-primary-600 text-white border-primary-600 shadow-md' : 'bg-white text-primary-600 border-primary-200 hover:border-primary-400'}`}
                                            >
                                                Monthly
                                            </button>
                                        </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-3 gap-3 mb-3">
                                            {['20000', '50000', '100000', '250000', '500000', '1000000'].map((amt) => (
                                                <button
                                                    ...
                                                    className={`py-3 px-2 rounded-xl font-bold border-2 transition-all hover:scale-105 ${amount === amt && !showCustomAmount ? 'bg-secondary-500 text-white border-secondary-500 shadow-lg' : 'bg-white text-gray-700 border-gray-200 hover:border-secondary-400'}`}
                                                >
                                        ...
                                        <button
                                            ...
                                            className={`w-full py-3 px-4 rounded-xl font-bold border-2 transition-all ${showCustomAmount ? 'bg-pink-500 text-white border-pink-500 shadow-md' : 'bg-white text-pink-600 border-pink-200 hover:border-pink-400'}`}
                                        >
                                            Enter Custom Amount
                                        </button>
                                        {showCustomAmount && (
                                            <div className="mt-3 relative">
                                                ...
                                                <input
                                                    ...
                                                    className="w-full pl-20 pr-4 py-3 border-2 border-primary-200 rounded-xl focus:ring-4 focus:ring-primary-100 focus:border-primary-500 font-bold text-xl text-primary-900"
                                    ...
                                    <div>
                                        ...
                                        <div className="grid grid-cols-2 gap-4">
                                            <button
                                                ...
                                                className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all hover:scale-105 ${paymentMethod === 'mobile_money' ? 'border-secondary-500 bg-secondary-50 ring-2 ring-secondary-500 shadow-lg' : 'border-gray-200 hover:border-gray-300'}`}
                                            >
                                                ...
                                                <div className="text-left">
                                                    ...
                                                    <span className="block text-xs text-gray-500">MTN / Airtel</span>
                                                </div>
                                            </button>
                                            ...
                                            <button
                                                ...
                                                className={`p-4 rounded-xl border-2 flex items-center gap-3 transition-all hover:scale-105 ${paymentMethod === 'bank_transfer' ? 'border-pink-500 bg-pink-50 ring-2 ring-pink-500 shadow-lg' : 'border-gray-200 hover:border-gray-300'}`}
                                            >
                                    ...
                                    <div className="bg-gray-50 rounded-xl p-6 space-y-4 border border-gray-200">
                                        <h3 className="font-bold text-gray-900 text-lg mb-4">Your Contact Details</h3>
                                        ...
                                        <div>
                                            ...
                                            <input
                                                type="text"
                                                required
                                                className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-4 focus:ring-primary-100 transition-all ${errors.donor_name ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-primary-500'}`}
                                        ...
                                        <div className="grid md:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <input
                                                    type="email"
                                                    required
                                                    className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-4 focus:ring-primary-100 transition-all ${errors.email ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-primary-500'}`}
                                                    value={details.email}
                                            ...
                                            <div>
                                                ...
                                                <input
                                                    type="tel"
                                                    required
                                                    className={`w-full px-4 py-3 border-2 rounded-lg focus:ring-4 focus:ring-primary-100 transition-all ${errors.phone_number ? 'border-red-500 focus:border-red-500' : 'border-gray-300 focus:border-primary-500'}`}
                                                ...
                                                <p className="text-xs text-gray-500 mt-1">Required for SMS confirmation</p>
                                            </div>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <textarea
                                                rows="3"
                                                className="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:ring-4 focus:ring-primary-100 focus:border-primary-500 transition-all resize-none"
                                        ...
                                        <div className="flex items-center gap-3 pt-2">
                                            ...
                                            />
                                            <label htmlFor="anon" className="text-sm text-gray-700 font-medium">Make my donation anonymous</label>
                                        </div>
                                    </div>
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        ...
                        <div className="bg-white rounded-2xl p-8 border border-primary-100 shadow-md">
                            <h3 className="text-xl font-bold text-primary-900 mb-4">Secure & Transparent</h3>
